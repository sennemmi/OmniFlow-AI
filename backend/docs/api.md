...
| `sandbox_test` | boolean | 沙箱测试功能是否启用（由配置项 SANDBOX_TEST_ENABLED 控制） |

---

### GET /api/v1/health/detailed

详细健康检查端点，返回更详细的系统健康状态信息。
...
5. **以状态管理为荣**: 所有可配置项通过 Config 类统一管理，避免硬编码
